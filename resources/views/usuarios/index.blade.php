...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="/usuarios/create" class="btn btn-dark mb-4">Crear Nuevo</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; align-items: center;">
                                <a href="{{ route('usuarios.edit', $usuarios->id) }}" class="btn btn-primary" style="margin-right: 10px;">Editar</a>
